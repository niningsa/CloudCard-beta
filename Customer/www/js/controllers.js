angular.module('starter.controllers', [])
  ...
  .controller('circleCtrl', function($scope,$state, $rootScope, $ionicScrollDelegate) {
    ...
    baidu_location.getCurrentPosition(function(data){
      ...
      //调用方法更具坐标来解析地址
      $scope.getGeo();
      var point=(loc.longitude,loc.latitude);
      ...
      // 将标注添加到地图中
      var points=[ {longitude:loc.longitude,latitude:loc.latitude},
      ...
      //将圆形扩状物加载到地图上
      var circle = new BMap.Circle(point,30,{fillColor:"#22B2E7", strokeWeight: 1 ,fillOpacity: 0.3, strokeOpacity: 0.3,enableEditing:true});
      ...
      marker.addEventListener("click", function(){
        //alert("精度是："+loc.longitude+"维度是："+loc.latitude);

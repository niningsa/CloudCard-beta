...
.service('applySellerService', function($q) {
  return {
    ...
    applySellerRegister: function (businessName, phone, businessLicence, payment, alipayAccount, wxAccount, bankName, bankCard) {
